Create a single horizontal sprite strip for the Codex app digital pet `crawlstack-polished` in the state `running-left`.
...
Full gait rewrite:
- Replace the previous directional movement completely. Do not imitate the old running-left row and do not simply mirror the rightward row.
